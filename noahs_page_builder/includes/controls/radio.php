...
class Control_Radio extends Controls_Base {
	...
	public function content_template($data, $name, $value) {
		...
		<div class="form-check form-switch">
			<input type="radio" id="option-<?php echo $data['item_id']; ?>" name="element[<?php echo $data['item_id']; ?>]" value="" class="form-check-input"  field-settings>
