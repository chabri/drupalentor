...
if(!class_exists('element_drupalentor_image_content')):
   class element_drupalentor_image_content{
      ...
      public static function render_content( $attr = array(), $content = '' ){
        ...
        $style = ImageStyle::load($image_style);
         if($background) $background = $style->buildUrl(str_replace('/sites/default/files/', 'public://', $background)); 
         ...
         <?php if($skin == 'skin-v1'){ ?>
            <div class="gsc-image-content <?php print $el_class; ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               ...
               <div class="box-content">
                  ...
                  <?php if($link){ ?>
                     <div class="read-more btn-container"><a class="btn btn-theme" <?php print $target ?> href="<?php print $link ?>"><?php print $text_link ?></a></div>
                  <?php } ?>
               </div>  
            </div>
         <?php } ?>   
