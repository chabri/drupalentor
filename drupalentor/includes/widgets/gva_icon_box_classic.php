<?php 
if(!class_exists('element_drupalentor_icon_box_classic')):
   class element_drupalentor_icon_box_classic{
      public function render_form(){
         $fields = array(
            'type' => 'element_drupalentor_icon_box_classic',
         ...
         <?php if($icon_position=='top-center' || $icon_position=='top-left' || $icon_position=='top-right' || $icon_position=='right' || $icon_position=='left'){ ?>
            <div class="widget gsc-icon-box <?php if(count($class)>0) print implode(' ',$class) ?>" <?php if(count($style) > 0) print 'style="'.implode($style, ';').'"' ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               ...
               <div class="highlight_content">
                  ...
                  <?php } ?>  
                    <?php if($button_text){ ?>
                     <div class="btn-container btn-center"><a class="btn btn-primary small" href="<?php print $link ?>" <?php print $target; ?>><?php print $button_text; ?></a></div>
                  <?php } ?>   
               </div>
