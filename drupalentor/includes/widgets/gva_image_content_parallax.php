...
if(!class_exists('element_drupalentor_image_content_parallax')):
   class element_drupalentor_image_content_parallax{
      public function render_form(){
         return array(
           'type'          => 'drupalentor_image_content_parallax',
               ...
               <div class="content-inner">
                 ...
                 <?php if($link){ ?>
                   <div class="btn-container">
                     <a class="btn btn-theme" href="<?php print $link ?>"><?php print $text_link ?></a>
                   </div>
                 <?php } ?>  
               </div>
             </div>  
