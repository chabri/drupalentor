<?php 
if(!class_exists('element_drupalentor_gmap')):
   class element_drupalentor_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ?>
       <?php ob_start() ?>
         <script src="//maps.googleapis.com/maps/api/js?key=AIzaSyCXErJYvTfNiAkq_2kKeMr7wKa100i2Yqs&ver=4.9.3"></script>
